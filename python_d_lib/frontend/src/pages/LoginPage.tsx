          ...
          <div className="mx-auto w-full max-w-md rounded-[18px] bg-white/95 px-6 py-9 shadow-[0_12px_48px_rgba(15,45,35,0.08),0_4px_16px_rgba(143,217,193,0.12)] ring-1 ring-[#FEF9C3]/70 ring-offset-2 ring-offset-[#f0fcf7] sm:px-8 sm:py-10">
            ...
            <p className="mt-2 text-center text-caption text-ink-muted">
              ...
              <span className="mt-2 block leading-snug">
                登录时请选择身份：教师不限年级；学生若低于 {GRADING_MIN_GRADE} 年级（未到初中），须填写家长或教师确认码方可登录（演示口令：
            ...
            {status === "success" ? (
              ...
              <form className="mt-8 space-y-5" onSubmit={handleSubmit} noValidate>
                ...
                <fieldset className="rounded-xl border border-black/[0.08] bg-surface-page/60 p-4">
                  <legend className="px-1 text-caption font-bold text-ink">身份（演示）</legend>
                  <div className="mt-1 flex flex-col gap-3 sm:flex-row">
                    <label className="flex flex-1 cursor-pointer items-center gap-2.5 rounded-lg border border-black/[0.08] bg-white px-3 py-2.5 text-small font-semibold text-ink shadow-sm has-[:checked]:border-accent-mint has-[:checked]:ring-2 has-[:checked]:ring-accent-mint/25">
                      <input
                        type="radio"
                        name="login-role"
