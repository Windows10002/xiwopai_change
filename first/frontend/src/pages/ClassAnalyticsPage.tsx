    ...
    <div className="page-bg-hero-stunning relative flex min-h-screen flex-col">
      ...
      <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-6 px-4 py-8 md:px-6 md:py-10">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <h1 className="text-2xl font-extrabold text-ink">班级学情看板</h1>
          ...
          <button
            type="button"
            onClick={refresh}
            className="inline-flex min-h-10 items-center gap-2 rounded-xl border border-black/[0.08] bg-white px-4 text-small font-bold text-ink-muted shadow-sm hover:border-primary/30"
          >
        ...
        <div className="grid min-h-[24rem] grid-cols-1 gap-6 lg:grid-cols-[minmax(0,14rem)_minmax(0,1fr)]">
          <aside className="rounded-2xl border border-black/[0.08] bg-white/95 p-3 shadow-card">
            <p className="px-2 py-1 text-caption font-bold text-ink-muted">批次 / 分组</p>
            {groups.length === 0 ? (
