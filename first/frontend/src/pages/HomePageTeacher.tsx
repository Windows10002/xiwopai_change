          ...
          <div className="rounded-[28px] bg-white/95 px-5 py-9 shadow-[0_28px_90px_rgba(15,90,75,0.14)] ring-1 ring-white/90 backdrop-blur-sm sm:px-8 sm:py-10 md:px-11 md:py-12">
            ...
            <div className="mx-auto mt-8 grid max-w-2xl grid-cols-1 gap-3 sm:grid-cols-2">
              <Link
                ...
                className="flex items-center justify-center gap-2 rounded-2xl border border-primary/20 bg-primary-tint/70 px-4 py-3 text-small font-bold text-ink-navActive shadow-sm transition hover:border-primary/35 hover:bg-primary-tint"
              >
              ...
              <Link
                to="/class-analytics"
                className="flex items-center justify-center gap-2 rounded-2xl border border-sky-200/80 bg-sky-50/90 px-4 py-3 text-small font-bold text-sky-900 shadow-sm transition hover:border-sky-300"
              >
                班级看板
              </Link>
              <Link
                to="/feedback-dashboard"
                className="flex items-center justify-center gap-2 rounded-2xl border border-amber-200/80 bg-amber-50/90 px-4 py-3 text-small font-bold text-amber-950 shadow-sm sm:col-span-2"
              >
                判题反馈看板
              </Link>
            </div>
